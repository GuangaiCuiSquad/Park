tableextension 52789 "Responsibility Center Ext." extends "Responsibility Center"
{
    fields
    {
        field(52750; "Picture Two"; Blob)
        {
            DataClassification = ToBeClassified;
        }
        field(52751; Treasurer; Code[20])
        {
            DataClassification = ToBeClassified;
            Caption = 'Treasurer';
        ...
        field(52752; "Automatic Hold"; Boolean)
        {
            DataClassification = ToBeClassified;
        ...
        field(52753; "P.O. FAX From Name"; Text[50])
        {
            DataClassification = ToBeClassified;
            Caption = 'Nome De FAX Transf. Banc.';
        }
        field(52754; "P.O. FAX Signature 1"; Text[50])
        {
            DataClassification = ToBeClassified;
            Caption = 'Assin. 1 FAX Transf. Banc.';
        }
        field(52755; "P.O. FAX Signature 2"; Text[50])
        {
            DataClassification = ToBeClassified;
            Caption = 'Assin. 1 FAX Transf. Banc.';
        }
        field(52756; "PS2 Filename"; Text[250])
        {
            DataClassification = ToBeClassified;
            Caption = 'Ficheiro PS2';
            InitValue = 'C:\';
        }
        field(52757; "Aspects Max"; Integer)
        {
            DataClassification = ToBeClassified;
            Caption = 'Aspects Max';
        }
        field(52758; Picture; Blob)
        {
            DataClassification = ToBeClassified;
        }
    }
