tableextension 52765 "Comment Line Ext." extends "Comment Line"
{
    /*
    ...
    */
    fields
    {
        ...
        field(52750; "Document Type"; Option)
        {
        ...
        field(52751; "Caminho PDFs"; Text[250])
        {
            DataClassification = ToBeClassified;
        }
        field(52752; Seperator; Option)
        {
            DataClassification = ToBeClassified;
            Caption = 'Seperator';
        ...
        field(52753; Description; Text[128])
        {
            DataClassification = ToBeClassified;
            Caption = 'Description';
        }
        field(52754; Goals; Text[250])
        {
            DataClassification = ToBeClassified;
            Caption = 'Goals';
        }
        field(52755; "Actual Status"; Option)
        {
            DataClassification = ToBeClassified;
        ...
        field(52756; "School Year"; Code[9])
        {
            DataClassification = ToBeClassified;
            Caption = 'School Year';
