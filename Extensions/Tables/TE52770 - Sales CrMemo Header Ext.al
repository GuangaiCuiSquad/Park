tableextension 52770 "Sales Cr.Memo Header Ext." extends "Sales Cr.Memo Header"
{
    /*
    ...
    */
    fields
    {
        ...
        field(52751; "Transferida de Armazem"; Boolean)
        {
            DataClassification = ToBeClassified;
            Description = 'Parque';
        }
        field(52752; "Origem Portal Fardas"; Boolean)
        {
            DataClassification = ToBeClassified;
            Description = 'Parque - Portal Fardas';
        }
        field(52753; Turma; Code[20])
        {
            DataClassification = ToBeClassified;
            Description = 'Turma onde o Aluno está inserido, para efeitos de ordenação';
            TableRelation = Class.Class;
        }
        field(52754; "Ano Escolaridade"; Code[10])
        {
            DataClassification = ToBeClassified;
            Description = 'Parque';
        }
        field(52755; Aluno; Code[20])
        {
            DataClassification = ToBeClassified;
            Description = 'Park';
        }
        field(52756; "Portal Created by"; Text[250])
        {
            DataClassification = ToBeClassified;
            Caption = 'User Criação Portal';
            Description = 'Park';
        }
        field(52757; "JDE Integrated"; Option)
        {
            DataClassification = ToBeClassified;
        ...
        field(52758; "Process by Education"; Boolean)
        {
            DataClassification = ToBeClassified;
