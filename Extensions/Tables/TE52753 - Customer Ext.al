tableextension 52753 "Customer Ext." extends Customer
{
    /*    
    ...
    */
    fields
    {
        ...
        field(52752; "Referencia ADC"; Code[11])
        {
            DataClassification = ToBeClassified;
        ...
        field(52753; "Débitos Directos"; Option)
        {
            DataClassification = ToBeClassified;
        ...
        field(52754; "EAN Enviado"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(52755; "ID CRED"; Code[6])
        {
            DataClassification = ToBeClassified;
        }
        field(52756; "Not Provisionable"; Boolean)
        {
            DataClassification = ToBeClassified;
            Caption = 'Not Provisionable';
        }
        field(52757; "Linked Costumers"; Integer)
        {
            Caption = 'Clientes Ligados';
            FieldClass = FlowField;
            CalcFormula = Count(Customer WHERE("VAT Registration No." = FIELD("VAT Registration No.")));
        }
        field(52758; "E-Mail2"; Text[80])
        {
            DataClassification = ToBeClassified;
            Caption = 'E-Mail';
            ExtendedDatatype = EMail;
        }
        field(52759; "JDE Payer No."; Code[20])
        {
            DataClassification = ToBeClassified;
            Caption = 'JDE Payer No.';
            Description = 'JDE_INT SQD RTV 20210625';
        }
        field(52760; "JDE Pupil No."; Code[20])
        {
            DataClassification = ToBeClassified;
            Caption = 'JDE Pupil No.';
        }
        field(52761; "Estado Civil"; Option)
        {
            DataClassification = ToBeClassified;
        ...
        field(52762; Capital; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(52763; Representante; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = Contact;
        }
        field(52764; "Matrícula Conservatória"; Text[30])
        {
            DataClassification = ToBeClassified;
        }
        field(52765; Conservatória; Text[30])
        {
            DataClassification = ToBeClassified;
        }
        field(52766; "Internal"; Boolean)
        {
            DataClassification = ToBeClassified;
            Caption = 'Grupo';
        ...
        field(52767; "Business Unit Code 2"; Code[10])
        {
            DataClassification = ToBeClassified;
        ...
        field(52768; "Student No."; Code[20])
        {
            DataClassification = ToBeClassified;
            Caption = 'Student No.';
            TableRelation = Students."No.";
        }
        field(52769; "User Family No."; Code[20])
        {
            DataClassification = ToBeClassified;
