tableextension 52759 "Sales Line Ext." extends "Sales Line"
{
    /*    
    ...
    New field: 52752 - "JDE Integrated"
    */
    fields
    {
        modify("No.")
        ...
        field(52750; "Cash-flow code"; Code[10])
        {
            DataClassification = ToBeClassified;
            Caption = 'Cash-flow code';
        }
        field(52751; "Qtd. Transferida"; Integer)
        {
            DataClassification = ToBeClassified;
            Description = 'Parque';
        }
        field(52752; "JDE Integrated"; Option)
        {
            DataClassification = ToBeClassified;
