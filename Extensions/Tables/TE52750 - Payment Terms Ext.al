tableextension 52750 "Payment Terms Ext." extends "Payment Terms"
{
    fields
    {
        field(52750; "S&R Adjustment Base Date"; Option)
        {
        ...
        field(52751; "Adjustment Day 1"; Integer)
        {
            DataClassification = ToBeClassified;
            Description = 'ADDED BY NCS PORTUGAL';
            MinValue = 0;
        ...
        field(52752; "Adjustment Day 2"; Integer)
        {
            DataClassification = ToBeClassified;
            Description = 'ADDED BY NCS PORTUGAL';
            MinValue = 0;
        ...
        field(52753; "Adjustment Day 3"; Integer)
        {
            DataClassification = ToBeClassified;
            Description = 'ADDED BY NCS PORTUGAL';
            MinValue = 0;
        ...
        field(52754; "Adjustment Day 4"; Integer)
        {
            DataClassification = ToBeClassified;
            Description = 'ADDED BY NCS PORTUGAL';
            MinValue = 0;
        ...
        field(52755; "P&P Adjustment Base Date"; Option)
        {
            DataClassification = ToBeClassified;
