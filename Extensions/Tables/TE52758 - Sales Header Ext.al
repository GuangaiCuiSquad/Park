tableextension 52758 "Sales Header Ext." extends "Sales Header"
{
    /*
    ...
    */
    fields
    {
        ...
        field(52750; "Origem Portal Fardas"; Boolean)
        {
            DataClassification = ToBeClassified;
            Description = 'Parque - Portal Fardas';
        }
        field(52751; Turma; Code[20])
        {
            DataClassification = ToBeClassified;
            Description = 'Turma onde o Aluno está inserido, para efeitos de ordenação';
        }
        field(52752; "Ano Escolaridade"; Code[10])
        {
            DataClassification = ToBeClassified;
            Description = 'Parque';
        }
        field(52753; Aluno; Code[20])
        {
            DataClassification = ToBeClassified;
            Description = 'Park';
        }
        field(52754; "Portal Created by"; Text[250])
        {
            DataClassification = ToBeClassified;
            Description = 'Park';
            Caption = 'User Criação Portal';
        }
        field(52755; "JDE Integrated"; Option)
        {
            DataClassification = ToBeClassified;
        ...
        field(52756; "Service Invoice"; Boolean)
        {
            DataClassification = ToBeClassified;
            Caption = 'Service Invoice';
            Description = 'JDE_INT SQD RTV 20210730';
        }
        field(52757; "JDE Payer No."; Code[20])
        {
        ...
        field(52758; "JDE Pupil No."; Code[20])
        {
        ...
        field(52759; "Process by Education"; Boolean)
        {
            DataClassification = ToBeClassified;
            Caption = 'Process by Education';
        }
        field(52760; Company; Text[30])
        {
            DataClassification = ToBeClassified;
            Caption = 'Company';
