tableextension 52788 "Item Variant Ext." extends "Item Variant"
{
    /*
    ...
    */
    fields
    {
        ...
        field(52751; "Qty. on Purch. Order"; Decimal)
        {
            FieldClass = FlowField;
        ...
        field(52752; "Qty. on Sales Order"; Decimal)
        {
            FieldClass = FlowField;
        ...
        field(52753; "Stock Mínimo"; Integer)
        {
